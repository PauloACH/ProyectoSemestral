...
public class GaleriaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rv1.setAdapter(new AdepterFotos());
    }

    private class AdepterFotos extends RecyclerView.Adapter<AdepterFotos.AdaptadorFotosHolder>{
        @NonNull
        @Override
        ...
        @Override
        public int getItemCount(){return archivos.length;}
        ...
        class AdaptadorFotosHolder extends RecyclerView.ViewHolder{
            ...
            public void imprimir(int position) {
                tv1.setText("Foto: "+archivos[position]);
                try {
